...
<?php
 if(isset($_GET['cartId']) ) {
   ...
   if(isset($_POST['updateQuantity'])) {
     $quantityUpdate = $_POST['quantityItem']
     $updateCart = $ct->updateCart($productId, $quantityUpdate);
   }
?>
      <div class="app__container">
        ...
        <div class="grid">
            ...
            <div class="table__item-content">
              ...
              <div class="table__item-content-text" style="width: 14%">
                <div class="item__description-quantity-input">
                  ...
                  />
                  <input type="hidden" name="<?php echo $result['productId'];?>">
          ...
          <div class="btn-continue-ordered">
              <button class="btn-continue" name="updateQuantity" style="border: none">Tiếp tục mua hàng</button>
              <button class="btn-ordered" name="updateQuantity" style="border: none">
