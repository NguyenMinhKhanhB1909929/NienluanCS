              ...
              <li class="header__navbar-item header__navbar-user">
                ...
                <ul class="header__navbar-user-menu">
                  ...
                  <form action="" method="post">
                    <button class="formLogout" type="submit" name="logout" style="cursor: pointer;">Đăng xuất</button>
                  </form>
                  </li>
                </ul>
              </li>
                ...
                while($result = $cartList->fetch_assoc()) {
                  ...
                  <ul class="header__cart-list-item">
                    <li class="header__cart-item">
                      <img
                        src="./Admin/production/uploads/<?php echo $result['image']; ?>"
                        alt=""
                        ...
                        <div class="header__cart-item-head">
                          ...
                          <div class="header__cart-item-price-wrap">
                            <span class="header__cart-item-price"
                              ><?php echo $fm->format_currency($result['price']); ?></span
                            >
                            <span class="header__cart-item-multiply">x</span>
                            <span class="header__cart-item-qut"><?php echo $result['quantity']; ?></span>
                          </div>
                        </div>
                      </div>
                    </li>
