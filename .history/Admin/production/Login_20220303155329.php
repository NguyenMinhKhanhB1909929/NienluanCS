                    ...
                    <div class="col-lg-12 login-form">
                        <form action="login.php" method="post">
                            <div class="form-group">
                                <label class="form-control-label" style="font-size: 16px;" name="adminUser">Tên đăng nhập:</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" style="font-size: 16px;" name="adminPass">Mật khẩu:</label>
