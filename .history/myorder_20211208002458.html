          ...
          <div class="grid__row app__content" style="padding-bottom: 18px">
            <div class="grid__column-2">
              ...
              <div class="myuser__navbar-des">
                ...
                <a href="./myuser.html" class="myuser__navbar-des-content"
                  >Hồ sơ</a
                >
            ...
            <div class="grid__column-10">
              <div class="myuser__content">
                ...
                <div class="myorder__content-wrap">
                  ...
                  <div class="myorder__content-wrap-title" style="width: 12%">
                    Mã giao dịch
                  </div>
                  <div class="myorder__content-wrap-title" style="width: 16%">
                    Ngày đặt hàng
                  </div>
                  <div class="myorder__content-wrap-title" style="width: 30%">
                    Tên sản phẩm
                  </div>
                ...
                <div class="myorder__content-item-wrap" style="margin-top: 0">
                  ...
                  <div class="myorder__content-wrap-item" style="width: 12%">
                    FC141000
                  </div>
                  <div
                  ...
                  >
                    <div
                      class="myorder__content-wrap-item1"
                      style="font-weight: 500; padding: 6px 0"
                    >
                      7:31pm
                    </div>
                    <div class="myorder__content-wrap-item1">5/12/2021</div>
                  </div>
                  <div class="myorder__content-wrap-item" style="width: 30%">
