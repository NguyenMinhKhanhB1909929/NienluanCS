            ...
            <div class="odered-and-payment">
              ...
              ?>
                <div class="user-odered__item-wrap">
                  ...
                  <div class="user-odered__item-price"><?php echo $resultGetCart['price']*$resultGetCart['quantity'];?></div>
                </div>
                              <?php
              ...
              ?>
                ...
                <div class="user-odered__subtotal">
                  <div class="user-odered-subtotal-wrap">
                    ...
                    <div class="user-odered-subtotal-price"><?php echo $total;?></div>
                  </div>
                ...
                <div class="user-odered__total-wrap">
                  ...
                  <div class="user-odered__total-wrap-price"><?php echo $total;?></div>
                </div>
              </div>
