      ...
      <div class="app__container">
        <div class="grid">
          <div class="ordered__success">
            ...
            <div class="ordered__success-id">Mã giao dịch: FC14100</div>
          </div>
          <div class="ordered__success-table">
            ...
            <div class="ordered__success-table-content">
              <div
                ...
                style="width: 15%"
              >
                <div class="ordered__success-table-content-hour">4:15pm</div>
                <div class="ordered__success-table-content-date">4/12/2021</div>
              </div>
              <div
                class="ordered__success-table-content-name"
                style="width: 50%"
              >
                Laptop Acer Nitro 5 AN515-45-R0B6 GeForce® RTX3060 6GB R7-5800H
                8G 512G 144Hz W10
              </div>
              <div
          ...
          <div class="order__success-btn-wrap">
            <a href="./FormUser.html" class="order__success-btn">
