...
<?php
  class product
  {
    ...
    public function insert_product($data, $files){
      ...
      $category = mysqli_real_escape_string($this->db->link, $data['productName']);
      $image = mysqli_real_escape_string($this->db->link, $data['productName']);
      $price = mysqli_real_escape_string($this->db->link, $data['productName']);
      $quantity = mysqli_real_escape_string($this->db->link, $data['productName']);
      $productDesc = mysqli_real_escape_string($this->db->link, $data['productName']);
