      ...
      <div class="app__container">
        ...
        <div class="grid">
            ...
            <div class="table__item-content">
              ...
              <div class="table__item-content-text" style="width: 14%">
                <div class="item__description-quantity-input">
                  <button onclick="event.defaultPrevented" name="updateQuantity" class="item__description-quantity-prev">-</button>
                  <input
                    type="text"
                    class="item__description-quantity-number"
                    value="<?php echo $result['quantity']; ?>"
                    name="quantityItem<?php echo $result['productId'];?>"
                  />
                  <input type="hidden" name="productId" value="<?php echo $result['productId'];?>">
                  <button onclick="event.defaultPrevented" name="updateQuantity" class="item__description-quantity-next">+</button>
                </div>
              </div>
              <div class="table__item-content-text" style="width: 15%">
                <span value="<?php
          ...
          <div class="btn-continue-ordered">
              <button class="btn-continue" name="" style="border: none">Tiếp tục mua hàng</button>
              <button class="btn-ordered" name="" style="border: none">
