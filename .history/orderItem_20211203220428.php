...
<html lang="en">
  ...
  <body>
        ...
        <div class="grid">
          ...
          <div class="header-with-search">
            <div class="header__logo">
              <a href="./FormUser.html" class="header__logo-link">
                <img
              ...
              <div class="header__cart-wrap">
                ...
                <div class="header__cart-list">
                  ...
                  <ul class="header__cart-list-item">
                    ...
                    <li class="header__cart-item">
                      <img
                        src="https://cf.shopee.vn/file/532fd35f902fb4a9532b11baddaaa7f5_tn"
                        alt=""
                        class="header__cart-img"
                      />
                      <div class="header__cart-item-info">
        ...
        <div class="grid">
          ...
          <div class="table__item">
            ...
            <div class="table__item-content">
              ...
              <div class="table__item-content-text" style="width: 33%">
                <a href="./ItemDes.html"
                  ...
                  R7-5800H 8G 512G 144Hz W10</a
                >
              </div>
              <div class="table__item-content-text" style="width: 15%">
                <span value="30990000" class="table__item-content-price1"
                  >30.990.000đ</span
                >
              </div>
              ...
              <div class="table__item-content-text" style="width: 15%">
                <span value="30990000" class="table__item-content-price"
                  >30.990.000đ</span
                >
              </div>
            ...
            <div class="table__item-sum-price">
              ...
              <span class="table__item-sum-price-number">30.990.000đ</span>
            </div>
          </div>
          <div class="btn-continue-ordered">
            <a href="./FormUser.html" class="btn-continue">Tiếp tục mua hàng</a>
            <a href="./FormPay.html" class="btn-ordered">
            ...
            <div class="auth-form__container">
              ...
              <div class="auth-form__form">
                ...
                <div class="auth-form__controls">
                  ...
                  <a href="./FormUser.html" class="btn btn-primary btn-login"
                    >ĐĂNG NHẬP</a
                  >
                </div>
              </div>
    ...
    <script src="./assets/javascript/quantityItem.js"></script>
