            ...
            <div class="odered-and-payment">
              ...
              ?>
                <div class="user-odered__item-wrap">
                  ...
                  echo echo $fm->format_currency($$totalItem);?></div>
                </div>
                              <?php
              ...
              ?>
                ...
                <div class="user-odered__subtotal">
                  <div class="user-odered-subtotal-wrap">
                    ...
                    <div class="user-odered-subtotal-price"><?php echo $fm->format_currency($total);?></div>
                  </div>
                ...
                <div class="user-odered__total-wrap">
                  ...
                  <div class="user-odered__total-wrap-price"><?php echo $fm->format_currency($total);?></div>
                </div>
              </div>
